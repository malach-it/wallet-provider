...
def wallet_configuration_endpoint():
    ...
    # check if this user has multiple wallet attestations
    ...
    if data_of_this_user.get('wallet_instance_jti') and jti != data_of_this_user.get('wallet_instance_jti'):
        ...
        message.message("Multiple enterprise wallet configuration", 'thierry.thevenet@talao.io', user_email + " is registering multiple configurations")
    else:
        pass
